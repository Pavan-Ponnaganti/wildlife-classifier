...
├── generate_metadata.py          # Fetch Wikipedia + IUCN data → animal_info.json
...
├── animal_info.json              # Wikipedia facts + IUCN statuses
...
Produces `animal_info.json` with species descriptions and conservation statuses used by the Streamlit app.
